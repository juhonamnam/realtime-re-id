...
def get_weighted_geometric_mean_similarity_score(v_scores, part_s_scores, thresholds=0.5):
    ...
    Args:
        ...
        thresholds (float or list[float], optional): Threshold(s) for logistic remapping. Defaults to 0.5.
